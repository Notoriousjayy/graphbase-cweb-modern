...
multiplication }\6
\&{long} \|m${},{}$ \|n;\C{ length of binary numbers to be multiplied }\6
\&{long} \\{seed};\C{ optional seed value, or $-1$ }\6
\&{char} \|x[\T{302}]${},{}$ \|y[\T{302}]${},{}$ \|z[\T{603}];\C{ input and
...
\&{register} \&{char} ${}{*}\|p,{}$ ${}{*}\|q,{}$ ${}{*}\|r{}$;\C{ pointers for
string manipulation }\6
\&{register} \&{long} \|a${},{}$ \|b;\C{ amounts being carried over while doing
radix conversion }\par
\U2.\fi
