...
${}\{{}$\5
\1\&{register} \&{long} ${}{*}\|p,{}$ ${}{*}\|q{}$;\C{ pointers to $C_j$ and
$w_j$ }\6
...
\X${}\E{}$\6
$\{{}$\5
\&{register} \&{char} ${}{*}\|r{}$;\C{ previous word possibly adjacent to \PB{%
\|q} }\6
...
\\{ch}(\|q+\T{2}))\LL\T{5})+\\{ch}(\|q+\T{3}))\LL\T{5})+\\{ch}(\|q+\T{4});$ %
...
\_of\_diff}(\T{0});{}$\2\6
\4${}\}{}$\2\6
${}{*}\|h\K\\{cur\_vertex};$ \&{for} ( $\|h\K\\{htab}[\T{1}]+(\\{raw\_hash}-(%
\\{ch}(\|q+\T{1})\LL\T{15}))$ $\MOD$ \&{hash\_prime};\7
${}{*}\|h;$ \\{hdown}(\T{1}) ) \6
${}\{{}$\1\6
${}\|r\K({*}\|h)\MG\\{name};{}$\6
...
\_of\_diff}(\T{1});{}$\2\6
\4${}\}{}$\2\6
${}{*}\|h\K\\{cur\_vertex};$ \&{for} ( $\|h\K\\{htab}[\T{2}]+(\\{raw\_hash}-(%
\\{ch}(\|q+\T{2})\LL\T{10}))$ $\MOD$ \&{hash\_prime};\7
${}{*}\|h;$ \\{hdown}(\T{2}) ) \6
${}\{{}$\1\6
${}\|r\K({*}\|h)\MG\\{name};{}$\6
...
\_of\_diff}(\T{2});{}$\2\6
\4${}\}{}$\2\6
${}{*}\|h\K\\{cur\_vertex};$ \&{for} ( $\|h\K\\{htab}[\T{3}]+(\\{raw\_hash}-(%
\\{ch}(\|q+\T{3})\LL\T{5}))$ $\MOD$ \&{hash\_prime};\7
${}{*}\|h;$ \\{hdown}(\T{3}) ) \6
${}\{{}$\1\6
${}\|r\K({*}\|h)\MG\\{name};{}$\6
...
\_of\_diff}(\T{3});{}$\2\6
\4${}\}{}$\2\6
${}{*}\|h\K\\{cur\_vertex};$ \&{for} ( $\|h\K\\{htab}[\T{4}]+(\\{raw\_hash}-%
\\{ch}(\|q+\T{4}))$ $\MOD$ \&{hash\_prime};\7
${}{*}\|h;$ \\{hdown}(\T{4}) ) \6
${}\{{}$\1\6
${}\|r\K({*}\|h)\MG\\{name};{}$\6
...
\X${}\E{}$\6
\&{if} (\|f) $\{$ \&{for} ( $\|h\K\\{htab}[\T{0}]+(\\{raw\_hash}-(\\{ch}(\|q)%
\LL\T{20}))$ $\MOD$ \&{hash\_prime};\7
${}{*}\|h;$ \\{hdown}(\T{0}) ) \6
${}\{{}$\1\6
${}\|r\K({*}\|h)\MG\\{name};{}$\6
\&{if} ${}(\\{match}(\T{1},\39\T{2},\39\T{3},\39\T{4})){}$\1\5
...
${}({*}\|f)({*}\|h);{}$\2\6
\4${}\}{}$\2\6
\&{for} ( $\|h\K\\{htab}[\T{4}]+(\\{raw\_hash}-\\{ch}(\|q+\T{4}))$ $\MOD$ %
\&{hash\_prime};\7
${}{*}\|h;$ \\{hdown}(\T{4}) ) \6
${}\{{}$\1\6
${}\|r\K({*}\|h)\MG\\{name};{}$\6
