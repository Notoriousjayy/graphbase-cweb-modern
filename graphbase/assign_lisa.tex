...
\&{unsigned} \&{long} \|m${}\K\T{0},{}$ \|n${}\K\T{0}{}$;\C{ number of rows and
columns desired }\6
\&{unsigned} \&{long} \|d${}\K\T{0}{}$;\C{ number of pixel values desired,
minus~1 }\6
\&{unsigned} \&{long} \\{m0}${}\K\T{0},{}$ \\{m1}${}\K\T{0}{}$;\C{ input will
be from rows $[\PB{\\{m0}}\,.\,.\,\PB{\\{m1}})$ }\6
\&{unsigned} \&{long} \\{n0}${}\K\T{0},{}$ \\{n1}${}\K\T{0}{}$;\C{ and from
columns $[\PB{\\{n0}}\,.\,.\,\PB{\\{n1}})$ }\6
\&{unsigned} \&{long} \\{d0}${}\K\T{0},{}$ \\{d1}${}\K\T{0}{}$;\C{ lower and
upper threshold of raw pixel scores }\6
