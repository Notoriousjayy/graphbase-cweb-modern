...
\&{unsigned} \&{long} \\{x\_range}${},{}$ \\{y\_range};\C{ upper bounds on
...
\\{y3};\2\2\6
${}\{{}$\5
\1\&{long} \\{s1}${},{}$ \\{s2}${},{}$ \\{s3};\C{ signs of individual terms }\6
\&{long} \|a${},{}$ \|b${},{}$ \|c;\C{ components of a redundant representation
...
\&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v,{}$ ${}{*}\|w;\2\2{}$\6
${}\{{}$\5
\1\&{register} \&{long} \\{wx}${}\K\|w\MG\\{x\_coord},{}$ \\{wy}${}\K\|w\MG\\{y%
\_coord}{}$;\C{ $x_w$, $y_w$ }\6
...
\&{Vertex} ${}{*}\|t,{}$ ${}{*}\|u,{}$ ${}{*}\|v,{}$ ${}{*}\|w;\2\2{}$\6
${}\{{}$\5
\1\&{register} \&{long} \\{wx}${}\K\|w\MG\\{x\_coord},{}$ \\{wy}${}\K\|w\MG\\{y%
\_coord}{}$;\C{ $x_w$, $y_w$ }\6
\&{long} \\{tx}${}\K\|t\MG\\{x\_coord}-\\{wx},{}$ \\{ty}${}\K\|t\MG\\{y%
\_coord}-\\{wy}{}$;\C{ $x_t-x_w$, $y_t-y_w$ }\6
\&{long} \\{ux}${}\K\|u\MG\\{x\_coord}-\\{wx},{}$ \\{uy}${}\K\|u\MG\\{y%
\_coord}-\\{wy}{}$;\C{ $x_u-x_w$, $y_u-y_w$ }\6
\&{long} \\{vx}${}\K\|v\MG\\{x\_coord}-\\{wx},{}$ \\{vy}${}\K\|v\MG\\{y%
\_coord}-\\{wy}{}$;\C{ $x_v-x_w$, $y_v-y_w$ }\6
...
\&{Vertex} ${}{*}\|t,{}$ ${}{*}\|u,{}$ ${}{*}\|v,{}$ ${}{*}\|w;\2\2{}$\6
${}\{{}$\5
\1\&{register} \&{long} \\{vx}${}\K\|v\MG\\{x\_coord},{}$ \\{wy}${}\K\|w\MG\\{y%
\_coord};{}$\7
...
\&{siz\_t} \\{min\_arc}${},{}$ \\{max\_arc};\C{ \PB{${\AND}\\{arc\_block}[%
...
\2\5
\&{while} ${}(\|x\MG\|u);{}$\6
${}\|a\K{}$(\&{arc} ${}{*}){}$ \|x${}\MG\|v{}$;\C{ terminal node points to the
arc we want }\par
\U34.\fi
...
\&{node} ${}{*}\\{xp},{}$ ${}{*}\\{xpp};\2\2{}$\6
${}\{{}$\5
\1\&{register} \&{arc} ${}{*}\\{ep}\K\|e\MG\\{next},{}$ ${}{*}\\{cp}\K\|c\MG%
\\{next},{}$ ${}{*}\\{cpp}\K\\{cp}\MG\\{next};{}$\7
${}\|e\MG\\{next}\K\|c{}$;\5
${}\|c\MG\\{next}\K\\{cpp}{}$;\5
${}\\{cpp}\MG\\{next}\K\|e;{}$\6
