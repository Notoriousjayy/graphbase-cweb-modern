...
\&{unsigned} \&{long} \|m${},{}$ \|n;\C{ number of rows and columns desired }\6
\&{unsigned} \&{long} \|d;\C{ maximum pixel value desired }\6
\&{unsigned} \&{long} \\{m0}${},{}$ \\{m1};\C{ input will be from rows $[\PB{%
\\{m0}}\,.\,.\,\PB{\\{m1}})$ }\6
\&{unsigned} \&{long} \\{n0}${},{}$ \\{n1};\C{ and from columns $[\PB{\\{n0}}%
\,.\,.\,\PB{\\{n1}})$ }\6
\&{unsigned} \&{long} \\{d0}${},{}$ \\{d1};\C{ lower and upper threshold of raw
pixel scores }\6
...
\6
\&{register} \&{long} \|k${},{}$ \|l;\C{ the current row and column of output }%
\6
\&{register} \&{long} \|i${},{}$ \|j;\C{ all-purpose indices }\6
\&{long} \\{cap\_M}${},{}$ \\{cap\_N};\C{ \PB{$\\{m1}-\\{m0}$} and \PB{$\\{n1}-%
\\{n0}$}, dimensions of the input }\6
...
doesn't overflow }\6
\&{register} \&{long} \|r${},{}$ \|k${},{}$ \|q${},{}$ \\{br};\6
\&{long} \\{a\_thresh}${},{}$ \\{b\_thresh};\7
\&{if} ${}(\|n\Z\\{nmax}){}$\1\5
\&{return} ${}(\|n*\|a)/\|b;{}$\2\6
${}\\{a\_thresh}\K\|b-\|a;{}$\6
...
\_lisa}} }\6
\&{register} \&{long} \|j${},{}$ \|k${},{}$ \|l;\C{ all-purpose indices }\6
