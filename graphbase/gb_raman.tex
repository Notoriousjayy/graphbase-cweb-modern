...
\&{register} \&{long} \|a${},{}$ \\{aa}${},{}$ \|k;\C{ primary indices in loops
}\6
\&{long} \|b${},{}$ \\{bb}${},{}$ \|c${},{}$ \\{cc}${},{}$ \|d${},{}$ \\{dd};%
\C{ secondary indices }\6
...
\&{typedef} \&{struct} ${}\{{}$\1\6
\&{long} \\{a0}${},{}$ \\{a1}${},{}$ \\{a2}${},{}$ \\{a3};\C{ coefficients of a
quaternion }\6
...
${}\{{}$\5
\1\&{long} \\{sa}${},{}$ \\{sb};\C{ $p-a^2$, $p-a^2-b^2$ }\6
...
\&{long} \|a${},{}$ \|b${},{}$ \|c${},{}$ \|d;\C{ a solution to
$a^2+b^2+c^2+d^2=p$ }\2\2\6
${}\{{}$\1\6
...
${}\{{}$\5
\1\&{register} \&{long} \|g${},{}$ \|h;\6
\&{long} \\{a00}${},{}$ \\{a01}${},{}$ \\{a10}${},{}$ \\{a11};\C{ entries of $2%
\times2$ matrix }\7
...
${}\{{}$\5
\1\&{long} \|s${}\K\\{q\_sqrt}[\|q-\T{2}],{}$ \|t${}\K(\\{q\_sqrt}[\T{13}\MOD%
\|q]*\|s)\MOD\|q;{}$\7
${}\\{gen}[\T{0}].\\{a0}\K\T{1}{}$;\5
...
\&{else}\5
${}\{{}$\5
\1\&{long} \\{a00}${}\K\\{gen}[\|k].\\{a0},{}$ \\{a01}${}\K\\{gen}[\|k].%
\\{a1},{}$ \\{a10}${}\K\\{gen}[\|k].\\{a2},{}$ \\{a11}${}\K\\{gen}[\|k].%
\\{a3};{}$\7
${}\|a\K\|v\MG\|x.\|I{}$;\5
${}\|b\K\|v\MG\|y.\|I;{}$\6
\&{if} ${}(\|v\MG\|z.\|I\E\|q){}$\1\5
...
\&{long} \\{a00}${}\K\\{gen}[\|k].\\{a0},{}$ \\{a01}${}\K\\{gen}[\|k].%
\\{a1},{}$ \\{a10}${}\K\\{gen}[\|k].\\{a2},{}$ \\{a11}${}\K\\{gen}[\|k].%
\\{a3}{}$;\C{ the coefficients }\6
\&{register} \&{long} \\{num}${},{}$ \\{den};\C{ numerator and denominator }\7
\&{if} ${}(\|a\E\|q){}$\1\5
