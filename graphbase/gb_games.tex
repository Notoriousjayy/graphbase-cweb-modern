...
\6
\&{register} \&{long} \|j${},{}$ \|k;\C{ all-purpose indices }\par
\U7.\fi
...
\&{long} \\{a0}${},{}$ \\{u0}${},{}$ \\{a1}${},{}$ \\{u1};\C{ team scores in
press polls }\6
...
\&{static} \&{long} \\{ma0}${}\K\T{1451},{}$ \\{mu0}${}\K\T{666},{}$ \\{ma1}${}%
\K\T{1475},{}$ \\{mu1}${}\K\T{847}{}$;\C{ maximum poll values in the data }\6
...
${}\{{}$\5
\1\&{register} \&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v;{}$\6
\&{register} \&{long} \\{today}${}\K\T{0}{}$;\C{ current day of play }\6
\&{long} \\{su}${},{}$ \\{sv};\C{ points scored by each team }\6
