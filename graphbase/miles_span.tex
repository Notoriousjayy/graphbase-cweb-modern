...
$\\{report}(\|u,\39\|v,\39\|l){}$\1\1\6
\&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v{}$;\C{ adjacent vertices in the minimum
spanning tree }\6
...
\&{Arc} ${}{*}\\{aucket}[\T{64}],{}$ ${}{*}\\{bucket}[\T{64}]{}$;\C{ heads of
...
\&{long} \|d;\C{ its new \PB{\\{dist}} }\2\2\6
${}\{{}$\5
\1\&{register} \&{Vertex} ${}{*}\|p,{}$ ${}{*}\\{pp}{}$;\C{ parent and
grandparent of \PB{\|v} }\6
\&{register} \&{Vertex} ${}{*}\|u,{}$ ${}{*}\|w{}$;\C{ other vertices being
modified }\6
...
\C{ registers for manipulation of links }\6
...
\Y\B\4\X24:Priority queue subroutines\X${}\mathrel+\E{}$\6
$\\{qunite}(\|m,\39\|q,\39\\{mm},\39\\{qq},\39\|h){}$\1\1\6
\&{register} \&{long} \|m${},{}$ \\{mm};\C{ number of nodes in the forests }\6
\&{register} \&{Arc} ${}{*}\|q,{}$ ${}{*}\\{qq}{}$;\C{ binomial trees in the
...
\&{register} \&{Arc} ${}{*}\|r,{}$ ${}{*}\\{rr}{}$;\C{ remainders of the input
lists }\7
${}\|m\MRL{-{\K}}\|k{}$;\5
\&{if} (\|m)\1\5
...
${}\{{}$\5
\1\&{register} \&{Arc} ${}{*}\|p,{}$ ${}{*}\\{pp}{}$;\C{ current node and its
predecessor }\6
\&{register} \&{Arc} ${}{*}\|q,{}$ ${}{*}\\{qq}{}$;\C{ current minimum node and
its predecessor }\6
...
\&{register} \&{Arc} ${}{*}\|p,{}$ ${}{*}\|q,{}$ ${}{*}\|r{}$;\C{ current
position and neighboring positions }\7
${}\|o,\39\|m\K\|h\MG\\{qcount};{}$\6
${}\|p\K\|h;{}$\6
\&{while} (\|m)\5
${}\{{}$\1\6
...
\&{register} \&{Vertex} ${}{*}\|s,{}$ ${}{*}\|t{}$;\C{ beginning and end of the
small list }\6
...
in fragments }\6
\&{register} \&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v{}$;\C{ registers for list
manipulation }\6
\&{register} \&{Arc} ${}{*}\|a{}$;\C{ and another }\6
\&{register} \&{long} \|j${},{}$ \|k;\C{ index registers for stage 2 }\par
\A61.
\U55.\fi
...
\Y\B\4\X3:Global variables\X${}\mathrel+\E{}$\6
\&{long} \\{lo\_sqrt}${},{}$ \\{hi\_sqrt};\C{ \lsqrtn\ and \usqrtn\ }\par
\fi
...
\&{long} \\{old\_size}${},{}$ \\{new\_size};\C{ size of fragment \PB{\|u},
