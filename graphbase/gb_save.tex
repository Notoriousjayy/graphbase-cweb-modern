...
\M{20}We open the file in binary mode. This makes no difference on
UNIX-like operating systems; but it prevents Windows-like systems
from converting the single internal character \PB{\.{'\\n'}} to the
two external characters \PB{\.{'\\r'}} and \PB{\.{'\\n'}}.
...
\Y\B\4\X4:External functions\X${}\mathrel+\E{}$\6
...
\\{classify}((\&{util} ${}{*}){}$ ${}{\AND}(\|l),\39\|t{}$)\C{ explore field %
\PB{\|l} of type \PB{\|t} }\par
\Y\B\4\X7:Private functions\X${}\mathrel+\E{}$\6
...
\E{}$\6
\&{for} ${}(\|v\K{}$(\&{Vertex} ${}{*}){}$ \\{cur\_block}${}\MG\\{start%
\_addr};{}$ ${}\|v\Z{}$(\&{Vertex} ${}{*}){}$ \\{cur\_block}${}\MG\\{end%
\_addr};{}$ ${}\|v\PP){}$\5
${}\{{}$\1\6
${}\\{comma\_expected}\K\T{0};{}$\6
...
\&{for} ${}(\|a\K{}$(\&{Arc} ${}{*}){}$ \\{cur\_block}${}\MG\\{start\_addr};{}$
${}\|a\Z{}$(\&{Arc} ${}{*}){}$ \\{cur\_block}${}\MG\\{end\_addr};{}$ ${}\|a%
\PP){}$\5
${}\{{}$\1\6
${}\\{comma\_expected}\K\T{0};{}$\6
