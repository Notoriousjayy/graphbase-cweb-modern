...
\&{util} \|a${},{}$ \|b;\C{ multipurpose fields }\2\6
${}\}{}$ \&{Arc};\par
\fi
...
${}\\{loc}\K{}$(\&{char} ${}{*}){}$ \\{calloc}${}((\&{unsigned})((\|n+\T{2}*%
\|m+\T{255})/\T{256}),\39\T{256});{}$\6
\&{if} (\\{loc})\5
${}\{{}$\1\6
...
\&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v{}$;\C{ a newly created arc will go from \PB{%
\|u} to \PB{\|v} }\6
...
\&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v{}$;\C{ new arcs will go from \PB{\|u} to %
\PB{\|v} and from \PB{\|v} to \PB{\|u} }\6
...
arc~\PB{\|a} will be \PB{$\|a-\T{1}$} if and only if \PB{$\\{edge\_trick}%
\AND{}$(\&{siz\_t}) \|a}
is nonzero.
