...
\&{Vertex} ${}{*}\|u,{}$ ${}{*}\|v{}$;\C{ vertices of current interest }\6
\&{Arc} ${}{*}\|a{}$;\C{ arc of current interest }\6
\&{Vertex} ${}{*}\\{start},{}$ ${}{*}\\{goal}{}$;\C{ teams specified by the
user }\6
...
\\{list}} }\6
\&{long} \|m${},{}$ \|h;\C{ current lists of interest }\6
...
${}\\{size}[\|h]\PP;{}$\2\6
${}\{{}$\5
\1\&{register} \&{node} ${}{*}\|p,{}$ ${}{*}\|q{}$;\C{ node in list and its
predecessor }\7
...
${}\{{}$\5
\1\&{register} \&{node} ${}{*}\|r\K\NULL,{}$ ${}{*}\|s\K\\{list}[\MM\|m],{}$
${}{*}\|t;{}$\7
\&{while} (\|s)\1\5
