...
\&{unsigned} \&{long} \\{first\_chapter}${},{}$ \\{last\_chapter};\C{ interval
of chapters leading to edges }\6
...
\&{char} ${}{*}\\{title};{}$\6
\&{unsigned} \&{long} \|n${},{}$ \|x${},{}$ \\{first\_chapter}${},{}$ \\{last%
\_chapter};\6
\&{long} \\{in\_weight}${},{}$ \\{out\_weight}${},{}$ \\{seed};\2\2\6
${}\{{}$\5
...
\PB{\\{bi\_book}} }\6
\&{register} \&{long} \|j${},{}$ \|k;\C{ all-purpose indices }\6
...
\&{register} \&{Vertex} ${}{*}{*}\\{qq},{}$ ${}{*}{*}\\{rr}{}$;\C{ pointers
within the clique table }\7
\&{do}\5
${}\{{}$\5
...
${}\{{}$\5
\1\&{register} \&{Vertex} ${}{*}\|u\K{*}\\{qq},{}$ ${}{*}\|v\K{*}\\{rr};{}$\6
\&{register} \&{Arc} ${}{*}\|a;{}$\7
